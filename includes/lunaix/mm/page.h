...
#define PG_PERM_R           PG_PRESENT
#define PG_PERM_RW          PG_PRESENT | PG_WRITE
#define PG_PERM_UR          PG_PRESENT | PG_ALLOW_USER
#define PG_PERM_URW         PG_PRESENT | PG_WRITE | PG_ALLOW_USER
#define T_SELF_REF_PERM     PG_PERM_RW | PG_DISABLE_CACHE
